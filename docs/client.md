...
See the [ChatOptions](#chatoptions) for more details...
...
The full type definition is in [`src/index.ts`](https://github.com/cssnr/vitepress-chat/blob/master/src/index.ts#L6).
